...
Click the `reveal config vars` button and add the following:

![](https://i.imgur.com/9CKHcBM.png)

- make sure `MONGODB_URI` key matches exactly what you have in your `server.js` file for connecting with mongoose.
